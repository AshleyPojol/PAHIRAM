...
const LazyBorrowingStatus = React.lazy(() =>
  import("./Pages/BorrowerPages/BorrowingStatus/BorrowingStatus")
);
const LazyPenaltyRecords = React.lazy(() =>
  import("./Pages/BorrowerPages/PenaltyRecords/PenaltyRecords")
);
const LazyBorrowingHistory = React.lazy(() =>
  import("./Pages/BorrowerPages/BorrowingHistory/BorrowingHistory")
);
//Employees
